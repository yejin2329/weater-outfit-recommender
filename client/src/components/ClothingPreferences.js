        ...
        <div>
            ...
            {Object.entries(clothingOptions).map(([key, items]) => (
                ...
                <div>
                    ...
                    <input type="checkbox" name="windSensitive" checked={sensitivity.windSensitive} onChange={(e)=>updateSensitivity('windSensitive', e.target.checked)} disabled={readOnly} />
                </div>
